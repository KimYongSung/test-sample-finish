...
public class Response {
     ...
     * @return
     */
    public static Response error(ValidationException result) {
        return Objects.isNull(result) ? new Response(ErrorCode.CD_0001) : new Response(result.getLocalizedMessage());
    }
